...
require (
	github.com/Zamua/shale v0.18.2-0.20260819144609-c1929d3f72c8
...
// pkg/cluster's grpc transitives) requires the OLD monolithic
// google.golang.org/genproto which embeds googleapis/rpc/{status,code}.
// The newer split-out google.golang.org/genproto/googleapis/rpc module
// owns those import paths post-split. Force the old monolithic module
...
// replace in go.work and the equivalent one in backends/pebble/go.mod.
